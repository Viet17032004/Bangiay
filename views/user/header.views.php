    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarExample01">
        ...
        ?>
            ...
            <li class="nav-item" >
              <a class="nav-link" href="index.php?type=wishlist" id="">Giỏ hàng</a>
            </li>
            <li class="nav-item" style="display: flex; justify-content: center; align-items:center;" >
...
?>
  ...
  style="
    background-image: url(\'https://thodiaphuyen.com.vn/Media/Articles/240420104304/Gallery/shop-giay-phu-yen-5.jpg?width=786&height=590&quality=80&mode=crop\');
    height: 400px;
    margin-top: 58px;
  "
>
  <div class="mask" style="background-color: rgba(0, 0, 0, 0.6);">
    <div class="d-flex justify-content-center align-items-center h-100">
      <div class="text-white">
        <h1 class="mb-3">BLOG GIÀY SNEAKER</h1>
